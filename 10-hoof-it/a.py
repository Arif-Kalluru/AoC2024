# Return: set: A set of strings representing coordinates of unique reachable 9s
def solve(x, y, n, m, topograph, memo):
    ...
    for dx, dy in directions:
        ...
        if 0 <= nx < n and 0 <= ny < m and topograph[nx][ny] == topograph[x][y] + 1:
            memo[x][y].update(solve(nx, ny, n, m, topograph, memo))
...
def main():
    ...
    for x, y in zeros:
        total_count += len(solve(x, y, n, m, topograph, memo))
